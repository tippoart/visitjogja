...
<body>
    ...
    <div class="form">
        <form action=" <?php echo base_url('visit/process_login'); ?>" method="post">
            <h1>Masuk</h1>
            <input name="identity" type="text" placeholder="Nama Pengguna">

            <input id="pass" name="password" type="password" placeholder="Password">
            <i style="bottom: 44%;" id="showPass" class='bx bxs-tired'></i>
            <i style="bottom: 44%;" id="hidePass" class='bx bxs-shocked'></i>

            <button class="submit">Submit</button>
            <a href="<?php echo  base_url() ?>visit/signup">Belum Punya Akun?<span>Daftar</span></a>
        </form>
    </div>
