...
<body>
    <section>
        ...
        <div id="card_form" class="card text-bg-dark mb-3 p-4 ">
            ...
            <div class="card-body">
                <form action="<?= site_url('visit/tambahWisata') ?>" method="post" id="add_wisata" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
                    <div class="col-md-5 position-relative">
                        <label for="validationTooltip01" class="form-label">Judul</label>
                        <input name="judul" type="text" class="form-control" id="validationTooltip01" placeholder="Masukkan Judul" required>
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <input name="tanggal" type="date" class="form-control" id="validationTooltip02" required>
                        <div class="valid-tooltip ">
                            Siip!
                        </div>
                        <div class="invalid-tooltip bg-transparent text-warning ">
                    ...
                    <div class="col-md-5 position-relative">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <textarea name="deskripsi" type="text" class="form-control" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" placeholder="Masukkan Deskripsi" required> </textarea>
                            <div class="invalid-tooltip bg-transparent text-warning ">
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <textarea name="isi" type="text" class="form-control" placeholder="Masukkan Isi Lengkap Deskripsi" id="validationTooltip03" required> </textarea>
                        <div class="invalid-tooltip bg-transparent text-warning">
                            Mohon Masukkan Isi
                        </div>
                        <div class="valid-tooltip ">
                    ...
                    <div class="col-md-11 position-relative">
                        ...
                        <input name="gambar" style="width: 106.5%;" type="file" class="form-control" id="validationTooltip05" required multiple>
                        <div class="invalid-tooltip bg-transparent text-warning">
                    ...
                    <div class="col-md-11 position-relative">
                        ...
                        <input name="gambar_konten1" style="width: 106.5%;" type="file" class="form-control" id="validationTooltip05" required multiple>
                        <div class="invalid-tooltip bg-transparent text-warning">
                            Pilih Gambar Terlebih Dahulu
                        </div>
                        <div class="valid-tooltip ">
