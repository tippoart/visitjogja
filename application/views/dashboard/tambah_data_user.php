...
<body>
    <section>
        ...
        <div class="card text-bg-dark mb-3 p-4 " style="max-width: 50rem; height:26rem; border-radius:15px;">
            ...
            <div class="card-body">
                <form action="<?= site_url('visit/aksi_tambah_user') ?>" method="post" class="row g-3 needs-validation d-flex flex-column " novalidate>
                <div class="col-md-12 position-relative">
                        <label for="validationTooltipUsername" class="form-label">Nama Pengguna</label>
                        <div class="input-group has-validation">
                            <input type="text" name="username" id="username" class="form-control" placeholder="Masukkan nama pengguna" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" required>
                    ...
                    <div class="col-md-12 position-relative">
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Masukkan Email" id="validationTooltipEmail" aria-describedby="validationTooltipUsernamePrepend" required>
                            <div class="valid-tooltip">
                                Sipp!
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 position-relative">
                        ...
                        <div class="input-group has-validation">
                            <input type="Password" name="password" id="pass" class="form-control" placeholder="Masukkan Kata Sandi" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" required>
