    ...
    <div class="head">
        <nav class="text ">
            ...
            <ul id="menu-list" class="hidden">
                <li class="gayis">
                    <a href="<?php echo base_url() ?>visit/index_not_login">Beranda</a>
        ...
        <div class="main" data-aos="zoom-out-up">
            <div class="main1">
                ...
                <div class="artikel">
                    ...
                    <a href="<?php echo base_url('visit/data_wisata_not_login/' . $wisata_item->idwisata) ?>">selengkapnya...</a>
                </div>
            </div>
        </div>
    <?php endif; ?>
...
<footer data-aos="fade-up-right">
    ...
    <form action="<?php echo base_url() ?>visit/login" method="post">
        <h2>Hubungi Kami !</h2>
